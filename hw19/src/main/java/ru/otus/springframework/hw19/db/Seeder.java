package ru.otus.springframework.hw19.db;

import org.springframework.stereotype.Component;
import ru.otus.springframework.hw19.domain.*;
import ru.otus.springframework.hw19.repository.*;
import ru.otus.springframework.hw19.security.UserRole;
...
public class Seeder {
    ...
    public Seeder(UserRepository userRepository, BookInfoRepository repository, AuthorRepository authorRepository, GenreRepository genreRepository, CommentRepository commentRepository) {
    ...
    private void seedUsers() {
        ...
        userRepository.save(new User( "user", "user", UserRole.USER));
    }
