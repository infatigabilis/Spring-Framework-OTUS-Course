package ru.otus.springframework.hw04.service.printer;
...
public class TestPrinterImpl implements TestPrinter {
    ...
    private void askName() throws IOException {
        System.out.print(ms.getMessage("enter_your_name", new String[0], appSettings.getLocale()));
        reader.readLine();

        System.out.print(ms.getMessage("enter_your_last_name", new String[0], appSettings.getLocale()));
        reader.readLine();
